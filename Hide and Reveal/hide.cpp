// This program implements a program that reads a file, hide a message, and output a file with the hidden message
...
int main(int argc, char * argv[] ) {
    ...
    img.hide_message(argv[3]);
    img.write_image(argv[2]);
